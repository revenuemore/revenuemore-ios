#
#  Be sure to run `pod spec lint RevenueMore.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                    Simplify in-app purchases, subscription management, and revenue tracking with ease.
                   DESC

  spec.homepage     = "https://revenuemore.com"
  ...
  spec.author             = { "Bilal Durnagol" => "bilaldurnagol@gmail.com" }
  # Or just: spec.author    = "Bilal Durnagol"
  # spec.authors            = { "Bilal Durnagol" => "bilaldurnagol@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Bilal Durnagol"
